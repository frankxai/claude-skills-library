# Core features, specialized agents, PR-swarm management, configuration, workflows, CI/CD & monitoring

> Reference for the `github-code-review` skill. See [`../SKILL.md`](../SKILL.md).
